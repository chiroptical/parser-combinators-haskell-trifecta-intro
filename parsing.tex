...
\begin{frame}{US Phone Number Exercise: Problem and Types}
  ...
  \pygmentLines{\scriptsize}{79}{87}{haskell}{code/phoneNumber/src/Main.hs}
  \uncover<2->{
...
\begin{frame}{US Phone Number Exercise: Parser}
  ...
  \onslide*<2>{
    \pygmentLines{\scriptsize}{64}{66}{haskell}{code/phoneNumber/src/Main.hs}
    \begin{itemize}
      \item Either:
      \begin{itemize}
  ...
  \onslide*<5>{
    \pygmentLines{\scriptsize}{68}{76}{haskell}{code/phoneNumber/src/Main.hs}
  }
  \onslide*<6>{
    \pygmentLines{\scriptsize}{51}{53}{haskell}{code/phoneNumber/src/Main.hs}
    \vspace{-0.5cm}
    \pygmentLines{\scriptsize}{77}{77}{haskell}{code/phoneNumber/src/Main.hs}
    \vspace{-0.5cm}
    \begin{itemize}
